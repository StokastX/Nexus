...
void ViewportPanel::OnImGuiRender(bool fitRenderToViewport)
{
	...
	ImVec2 buttonSize = ImGui::CalcTextSize("Export") + ImGui::GetStyle().FramePadding * 2.0f;

	ImGui::SameLine(m_ViewportSize.x - buttonSize.x);
...
bool ViewportPanel::ExportRender()
{
